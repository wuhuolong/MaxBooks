...
namespace AssetBundles
{
    ...
    public class AssetBundleDownloadFromWebOperation : AssetBundleDownloadOperation
    {
        ...
        protected override void FinishDownload()
        {
            ...
            if (m_WWW.isDone)
            {
                byte[] bytes = m_WWW.downloadHandler.data;
            ...
            {
                Debug.Log("FinishDownload ��ɵ���webrequest������");
            }
        }
    ...
    public class AssetBundleLoadLevelSimulationOperation : AssetBundleLoadOperation
    {
        ...
        public AssetBundleLoadLevelSimulationOperation(string assetBundleName, string levelName, bool isAdditive)
        {
            ...
            LoadSceneParameters loadparam = new LoadSceneParameters();
            if (isAdditive)
            {
                loadparam.loadSceneMode = LoadSceneMode.Additive;
            }
            else
            {
                loadparam.loadSceneMode = LoadSceneMode.Single;
            }
            m_Operation = UnityEditor.SceneManagement.EditorSceneManager.LoadSceneAsyncInPlayMode(levelPaths[0], loadparam);
        }
