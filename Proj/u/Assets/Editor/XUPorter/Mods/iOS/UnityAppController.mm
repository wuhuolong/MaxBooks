...
#endif
    [xSdkInterface OnwillFinishLaunchingWithOptions];
    return YES;
}
...
- (void)applicationDidEnterBackground:(UIApplication*)application
{
    ...
    [xSdkInterface OnApplicationDidEnterBackground];
}
...
- (void)applicationWillEnterForeground:(UIApplication*)application
{
    ...
    [xSdkInterface OnApplicationWillEnterForeground];
}
...
- (void)applicationDidBecomeActive:(UIApplication*)application
{
    ...
    [xSdkInterface OnApplicationDidBecomeActive];
}
