...
namespace Mono.Data.Sqlite
{
  ...
  internal class SQLite3 : SQLiteBase
  {
    ...
    internal override byte[] GetTextBytes(SqliteStatement stmt, int index)
    {
        return GetStringBytes(UnsafeNativeMethods.sqlite3_column_text(stmt._sqlite_stmt, index), -1);
    }
