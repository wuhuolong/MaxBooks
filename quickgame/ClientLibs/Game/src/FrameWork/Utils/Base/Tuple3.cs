...
namespace xc
{
    ...
    public sealed class Tuple<T1, T2, T3>
    {
        ...
        {
            if (_o.GetType() != typeof(Tuple<T1, T2, T3>)) 
			{
                return false;
            }

            var other = (Tuple<T1, T2, T3>)_o;

            return this == other;
        }

        public static bool operator==(Tuple<T1, T2, T3> _a, Tuple<T1, T2, T3> _b)
        {
            return 
        ...
        public void Unpack(Action<T1, T2, T3> _unpacker_delegate)
        {
			_unpacker_delegate(get_itm1_, get_item2_, get_item3_);
        }
    }
}
