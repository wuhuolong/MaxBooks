...
namespace XLua.LuaDLL
{
	...
	public partial class Lua
	{
        ...
        /// <returns></returns>
        public static void lua_tostring_noret(IntPtr L, int index)
        {
            IntPtr strlen;
            IntPtr str = lua_tolstring(L, index, out strlen);
        }
...
#else
        public static void lua_pushint64(IntPtr L, long number)
        {
            lua_pushnumber(L, number);
        }

        public static void lua_pushuint64(IntPtr L, ulong number)
        {
            lua_pushnumber(L, number);
        }
        ...
        {
            return (ulong)lua_tonumber(L, idx);
        }
#endif
