...
namespace XLua.CSObjectWrap
{
    ...
    public class xcDBTextResourceDBAttrItemWrap
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					xc.DBTextResource.DBAttrItem __cl_gen_ret = new xc.DBTextResource.DBAttrItem();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to xc.DBTextResource.DBAttrItem constructor!");
        ...
        static int _g_get_attr_id(RealStatePtr L)
        {
            ...
            try {
                ...
                xc.DBTextResource.DBAttrItem __cl_gen_to_be_invoked = (xc.DBTextResource.DBAttrItem)translator.FastGetCSObj(L, 1);
