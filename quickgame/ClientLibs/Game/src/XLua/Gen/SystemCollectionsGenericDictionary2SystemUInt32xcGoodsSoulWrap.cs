...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemCollectionsGenericDictionary_2_SystemUInt32xcGoodsSoul_Wrap
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					System.Collections.Generic.Dictionary<uint, xc.GoodsSoul> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsSoul>();
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IEqualityComparer<uint>>(L, 2))
				{
					...
					System.Collections.Generic.Dictionary<uint, xc.GoodsSoul> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsSoul>(comparer);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IDictionary<uint, xc.GoodsSoul>>(L, 2))
				{
					System.Collections.Generic.IDictionary<uint, xc.GoodsSoul> dictionary = (System.Collections.Generic.IDictionary<uint, xc.GoodsSoul>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IDictionary<uint, xc.GoodsSoul>));
					
					System.Collections.Generic.Dictionary<uint, xc.GoodsSoul> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsSoul>(dictionary);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					System.Collections.Generic.Dictionary<uint, xc.GoodsSoul> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsSoul>(capacity);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<System.Collections.Generic.IDictionary<uint, xc.GoodsSoul>>(L, 2) && translator.Assignable<System.Collections.Generic.IEqualityComparer<uint>>(L, 3))
				{
					System.Collections.Generic.IDictionary<uint, xc.GoodsSoul> dictionary = (System.Collections.Generic.IDictionary<uint, xc.GoodsSoul>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IDictionary<uint, xc.GoodsSoul>));
					...
					System.Collections.Generic.Dictionary<uint, xc.GoodsSoul> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsSoul>(dictionary, comparer);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<System.Collections.Generic.IEqualityComparer<uint>>(L, 3))
				{
					...
					System.Collections.Generic.Dictionary<uint, xc.GoodsSoul> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsSoul>(capacity, comparer);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.Dictionary<uint, xc.GoodsSoul> constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<System.Collections.Generic.Dictionary<uint, xc.GoodsSoul>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					
					System.Collections.Generic.Dictionary<uint, xc.GoodsSoul> __cl_gen_to_be_invoked = (System.Collections.Generic.Dictionary<uint, xc.GoodsSoul>)translator.FastGetCSObj(L, 1);
        ...
        public static int __NewIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<System.Collections.Generic.Dictionary<uint, xc.GoodsSoul>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<xc.GoodsSoul>(L, 3))
				{
        ...
        static int _m_Add(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    uint key = LuaAPI.xlua_touint(L, 2);
                    xc.GoodsSoul value = (xc.GoodsSoul)translator.GetObject(L, 3, typeof(xc.GoodsSoul));
        ...
        static int _m_ContainsValue(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    xc.GoodsSoul value = (xc.GoodsSoul)translator.GetObject(L, 2, typeof(xc.GoodsSoul));
        ...
        static int _m_GetEnumerator(RealStatePtr L)
        {
            ...
            try {
                
                {
                        ...
                        System.Collections.Generic.Dictionary<uint, xc.GoodsSoul>.Enumerator __cl_gen_ret = __cl_gen_to_be_invoked.GetEnumerator(  );
                        translator.Push(L, __cl_gen_ret);
