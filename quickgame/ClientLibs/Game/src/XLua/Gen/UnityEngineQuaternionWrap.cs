...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineQuaternionWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			XUtils.BeginObjectRegister(typeof(UnityEngine.Quaternion), L, translator, 2, 7, 5, 5);
			XUtils.RegisterFunc(L, XUtils.OBJ_META_IDX, "__mul", __MulMeta);
            XUtils.RegisterFunc(L, XUtils.OBJ_META_IDX, "__eq", __EqMeta);
            
			XUtils.RegisterFunc(L, XUtils.METHOD_IDX, "ToAngleAxis", _m_ToAngleAxis);
			XUtils.RegisterFunc(L, XUtils.METHOD_IDX, "SetFromToRotation", _m_SetFromToRotation);
			XUtils.RegisterFunc(L, XUtils.METHOD_IDX, "Set", _m_Set);
			XUtils.RegisterFunc(L, XUtils.METHOD_IDX, "SetLookRotation", _m_SetLookRotation);
            ...
            XUtils.RegisterFunc(L, XUtils.GETTER_IDX, "z", _g_get_z);
            XUtils.RegisterFunc(L, XUtils.GETTER_IDX, "w", _g_get_w);
            ...
            XUtils.RegisterFunc(L, XUtils.SETTER_IDX, "z", _s_set_z);
            XUtils.RegisterFunc(L, XUtils.SETTER_IDX, "w", _s_set_w);
            
			XUtils.EndObjectRegister(typeof(UnityEngine.Quaternion), L, translator, __CSIndexer, __NewIndexer,
			    null, null, null);

		    XUtils.BeginClassRegister(typeof(UnityEngine.Quaternion), L, __CreateInstance, 14, 1, 0);
			XUtils.RegisterFunc(L, XUtils.CLS_IDX, "AngleAxis", _m_AngleAxis_xlua_st_);
            XUtils.RegisterFunc(L, XUtils.CLS_IDX, "FromToRotation", _m_FromToRotation_xlua_st_);
            XUtils.RegisterFunc(L, XUtils.CLS_IDX, "LookRotation", _m_LookRotation_xlua_st_);
            XUtils.RegisterFunc(L, XUtils.CLS_IDX, "Slerp", _m_Slerp_xlua_st_);
            XUtils.RegisterFunc(L, XUtils.CLS_IDX, "SlerpUnclamped", _m_SlerpUnclamped_xlua_st_);
            ...
            XUtils.RegisterFunc(L, XUtils.CLS_IDX, "RotateTowards", _m_RotateTowards_xlua_st_);
            XUtils.RegisterFunc(L, XUtils.CLS_IDX, "Inverse", _m_Inverse_xlua_st_);
            XUtils.RegisterFunc(L, XUtils.CLS_IDX, "Euler", _m_Euler_xlua_st_);
            XUtils.RegisterFunc(L, XUtils.CLS_IDX, "Dot", _m_Dot_xlua_st_);
            XUtils.RegisterFunc(L, XUtils.CLS_IDX, "Angle", _m_Angle_xlua_st_);
            
			
            XUtils.RegisterObject(L, translator, XUtils.CLS_IDX, "kEpsilon", UnityEngine.Quaternion.kEpsilon);
            
            XUtils.RegisterObject(L, translator, XUtils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.Quaternion));
			XUtils.RegisterFunc(L, XUtils.CLS_GETTER_IDX, "identity", _g_get_identity);
            
			
			XUtils.EndClassRegister(typeof(UnityEngine.Quaternion), L, translator);
        }
