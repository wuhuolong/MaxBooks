...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineVector4Wrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			XUtils.BeginObjectRegister(typeof(UnityEngine.Vector4), L, translator, 6, 7, 7, 4);
			...
			XUtils.EndObjectRegister(typeof(UnityEngine.Vector4), L, translator, __CSIndexer, __NewIndexer,
			    null, null, null);

		    XUtils.BeginClassRegister(typeof(UnityEngine.Vector4), L, __CreateInstance, 14, 4, 0);
            ...
            XUtils.RegisterObject(L, translator, XUtils.CLS_IDX, "kEpsilon", UnityEngine.Vector4.kEpsilon);
            
            XUtils.RegisterObject(L, translator, XUtils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.Vector4));
			...
			XUtils.EndClassRegister(typeof(UnityEngine.Vector4), L, translator);
        }
