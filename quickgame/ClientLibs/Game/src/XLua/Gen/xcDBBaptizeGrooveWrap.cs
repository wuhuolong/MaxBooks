...
namespace XLua.CSObjectWrap
{
    ...
    public class xcDBBaptizeGrooveWrap
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			XUtils.BeginObjectRegister(typeof(xc.DBBaptizeGroove), L, translator, 0, 2, 2, 1);
			...
			XUtils.EndObjectRegister(typeof(xc.DBBaptizeGroove), L, translator, null, null,
			    null, null, null);

		    XUtils.BeginClassRegister(typeof(xc.DBBaptizeGroove), L, __CreateInstance, 1, 0, 0);
			
			
            
            XUtils.RegisterObject(L, translator, XUtils.CLS_IDX, "UnderlyingSystemType", typeof(xc.DBBaptizeGroove));
			
			
			XUtils.EndClassRegister(typeof(xc.DBBaptizeGroove), L, translator);
        }
        ...
        static int _s_set_mInfos(RealStatePtr L)
        {
            ...
            try {
                ...
                xc.DBBaptizeGroove __cl_gen_to_be_invoked = (xc.DBBaptizeGroove)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.mInfos = (System.Collections.Generic.Dictionary<uint, xc.DBBaptizeGroove.DBBaptizeGrooveInfo>)translator.GetObject(L, 2, typeof(System.Collections.Generic.Dictionary<uint, xc.DBBaptizeGroove.DBBaptizeGrooveInfo>));
