...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemCollectionsGenericList_1Enumerator_SystemUInt32_Wrap
    {
        ...
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			translator.Push(L, default(System.Collections.Generic.List<uint>.Enumerator));
			return 1;
        ...
        static int _m_Dispose(RealStatePtr L)
        {
            ...
            System.Collections.Generic.List<uint>.Enumerator __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
