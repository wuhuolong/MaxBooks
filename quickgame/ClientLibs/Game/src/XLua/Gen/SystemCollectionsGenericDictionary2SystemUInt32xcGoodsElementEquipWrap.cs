...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemCollectionsGenericDictionary_2_SystemUInt32xcGoodsElementEquip_Wrap
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			XUtils.BeginObjectRegister(typeof(System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip>), L, translator, 0, 9, 4, 0);
			...
			XUtils.EndObjectRegister(typeof(System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip>), L, translator, __CSIndexer, __NewIndexer,
			    null, null, null);

		    XUtils.BeginClassRegister(typeof(System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip>), L, __CreateInstance, 1, 0, 0);
			
			
            
            XUtils.RegisterObject(L, translator, XUtils.CLS_IDX, "UnderlyingSystemType", typeof(System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip>));
			
			
			XUtils.EndClassRegister(typeof(System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip>), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip>();
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IEqualityComparer<uint>>(L, 2))
				{
					...
					System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip>(comparer);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IDictionary<uint, xc.GoodsElementEquip>>(L, 2))
				{
					System.Collections.Generic.IDictionary<uint, xc.GoodsElementEquip> dictionary = (System.Collections.Generic.IDictionary<uint, xc.GoodsElementEquip>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IDictionary<uint, xc.GoodsElementEquip>));
					
					System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip>(dictionary);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip>(capacity);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<System.Collections.Generic.IDictionary<uint, xc.GoodsElementEquip>>(L, 2) && translator.Assignable<System.Collections.Generic.IEqualityComparer<uint>>(L, 3))
				{
					System.Collections.Generic.IDictionary<uint, xc.GoodsElementEquip> dictionary = (System.Collections.Generic.IDictionary<uint, xc.GoodsElementEquip>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IDictionary<uint, xc.GoodsElementEquip>));
					...
					System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip>(dictionary, comparer);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<System.Collections.Generic.IEqualityComparer<uint>>(L, 3))
				{
					...
					System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip>(capacity, comparer);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip> constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
        ...
        public static int __NewIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<xc.GoodsElementEquip>(L, 3))
				{
					
					System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip> __cl_gen_to_be_invoked = (System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip>)translator.FastGetCSObj(L, 1);
					uint key = LuaAPI.xlua_touint(L, 2);
					__cl_gen_to_be_invoked[key] = (xc.GoodsElementEquip)translator.GetObject(L, 3, typeof(xc.GoodsElementEquip));
					LuaAPI.lua_pushboolean(L, true);
					return 1;
				}
        ...
        static int _m_GetEnumerator(RealStatePtr L)
        {
            ...
            try {
                
                {
                        ...
                        System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip>.Enumerator __cl_gen_ret = __cl_gen_to_be_invoked.GetEnumerator(  );
                        translator.Push(L, __cl_gen_ret);
