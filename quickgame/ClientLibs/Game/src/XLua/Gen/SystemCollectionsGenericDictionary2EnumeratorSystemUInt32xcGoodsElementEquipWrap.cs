...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemCollectionsGenericDictionary_2Enumerator_SystemUInt32xcGoodsElementEquip_Wrap
    {
        ...
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			translator.Push(L, default(System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip>.Enumerator));
			return 1;
        ...
        static int _m_MoveNext(RealStatePtr L)
        {
            ...
            System.Collections.Generic.Dictionary<uint, xc.GoodsElementEquip>.Enumerator __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
