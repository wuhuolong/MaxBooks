...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemCollectionsGenericList_1_SystemInt32_Wrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			XUtils.BeginObjectRegister(typeof(System.Collections.Generic.List<int>), L, translator, 0, 29, 2, 1);
			...
			XUtils.EndObjectRegister(typeof(System.Collections.Generic.List<int>), L, translator, __CSIndexer, __NewIndexer,
			    null, null, null);

		    XUtils.BeginClassRegister(typeof(System.Collections.Generic.List<int>), L, __CreateInstance, 1, 0, 0);
			
			
            
            XUtils.RegisterObject(L, translator, XUtils.CLS_IDX, "UnderlyingSystemType", typeof(System.Collections.Generic.List<int>));
			
			
			XUtils.EndClassRegister(typeof(System.Collections.Generic.List<int>), L, translator);
        }
