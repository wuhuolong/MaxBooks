...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemCollectionsGenericDictionary_2_SystemUInt32xcGoodsMountEquip_Wrap
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			XUtils.BeginObjectRegister(typeof(System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip>), L, translator, 0, 9, 4, 0);
			...
			XUtils.EndObjectRegister(typeof(System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip>), L, translator, __CSIndexer, __NewIndexer,
			    null, null, null);

		    XUtils.BeginClassRegister(typeof(System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip>), L, __CreateInstance, 1, 0, 0);
			
			
            
            XUtils.RegisterObject(L, translator, XUtils.CLS_IDX, "UnderlyingSystemType", typeof(System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip>));
			
			
			XUtils.EndClassRegister(typeof(System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip>), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip>();
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IEqualityComparer<uint>>(L, 2))
				{
					...
					System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip>(comparer);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IDictionary<uint, xc.GoodsMountEquip>>(L, 2))
				{
					System.Collections.Generic.IDictionary<uint, xc.GoodsMountEquip> dictionary = (System.Collections.Generic.IDictionary<uint, xc.GoodsMountEquip>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IDictionary<uint, xc.GoodsMountEquip>));
					
					System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip>(dictionary);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip>(capacity);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<System.Collections.Generic.IDictionary<uint, xc.GoodsMountEquip>>(L, 2) && translator.Assignable<System.Collections.Generic.IEqualityComparer<uint>>(L, 3))
				{
					System.Collections.Generic.IDictionary<uint, xc.GoodsMountEquip> dictionary = (System.Collections.Generic.IDictionary<uint, xc.GoodsMountEquip>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IDictionary<uint, xc.GoodsMountEquip>));
					...
					System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip>(dictionary, comparer);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<System.Collections.Generic.IEqualityComparer<uint>>(L, 3))
				{
					...
					System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip>(capacity, comparer);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip> constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
        ...
        public static int __NewIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<xc.GoodsMountEquip>(L, 3))
				{
					
					System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip> __cl_gen_to_be_invoked = (System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip>)translator.FastGetCSObj(L, 1);
					uint key = LuaAPI.xlua_touint(L, 2);
					__cl_gen_to_be_invoked[key] = (xc.GoodsMountEquip)translator.GetObject(L, 3, typeof(xc.GoodsMountEquip));
					LuaAPI.lua_pushboolean(L, true);
					return 1;
				}
        ...
        static int _m_GetEnumerator(RealStatePtr L)
        {
            ...
            try {
                
                {
                        ...
                        System.Collections.Generic.Dictionary<uint, xc.GoodsMountEquip>.Enumerator __cl_gen_ret = __cl_gen_to_be_invoked.GetEnumerator(  );
                        translator.Push(L, __cl_gen_ret);
