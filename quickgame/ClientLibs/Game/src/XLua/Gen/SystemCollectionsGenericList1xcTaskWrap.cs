...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemCollectionsGenericList_1_xcTask_Wrap
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			XUtils.BeginObjectRegister(typeof(System.Collections.Generic.List<xc.Task>), L, translator, 0, 29, 2, 1);
			...
			XUtils.EndObjectRegister(typeof(System.Collections.Generic.List<xc.Task>), L, translator, __CSIndexer, __NewIndexer,
			    null, null, null);

		    XUtils.BeginClassRegister(typeof(System.Collections.Generic.List<xc.Task>), L, __CreateInstance, 1, 0, 0);
			
			
            
            XUtils.RegisterObject(L, translator, XUtils.CLS_IDX, "UnderlyingSystemType", typeof(System.Collections.Generic.List<xc.Task>));
			
			
			XUtils.EndClassRegister(typeof(System.Collections.Generic.List<xc.Task>), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					System.Collections.Generic.List<xc.Task> __cl_gen_ret = new System.Collections.Generic.List<xc.Task>();
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IEnumerable<xc.Task>>(L, 2))
				{
					...
					System.Collections.Generic.List<xc.Task> __cl_gen_ret = new System.Collections.Generic.List<xc.Task>(collection);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					System.Collections.Generic.List<xc.Task> __cl_gen_ret = new System.Collections.Generic.List<xc.Task>(capacity);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<xc.Task> constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<System.Collections.Generic.List<xc.Task>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
        ...
        public static int __NewIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<System.Collections.Generic.List<xc.Task>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<xc.Task>(L, 3))
				{
					
					System.Collections.Generic.List<xc.Task> __cl_gen_to_be_invoked = (System.Collections.Generic.List<xc.Task>)translator.FastGetCSObj(L, 1);
					int key = LuaAPI.xlua_tointeger(L, 2);
					__cl_gen_to_be_invoked[key] = (xc.Task)translator.GetObject(L, 3, typeof(xc.Task));
					LuaAPI.lua_pushboolean(L, true);
					return 1;
				}
        ...
        static int _m_AsReadOnly(RealStatePtr L)
        {
            ...
            try {
                
                {
                        ...
                        System.Collections.ObjectModel.ReadOnlyCollection<xc.Task> __cl_gen_ret = __cl_gen_to_be_invoked.AsReadOnly(  );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _m_BinarySearch(RealStatePtr L)
        {
            ...
            try {
                ...
                if(__gen_param_count == 3&& translator.Assignable<xc.Task>(L, 2)&& translator.Assignable<System.Collections.Generic.IComparer<xc.Task>>(L, 3)) 
                {
                    xc.Task item = (xc.Task)translator.GetObject(L, 2, typeof(xc.Task));
                    System.Collections.Generic.IComparer<xc.Task> comparer = (System.Collections.Generic.IComparer<xc.Task>)translator.GetObject(L, 3, typeof(System.Collections.Generic.IComparer<xc.Task>));
                ...
                if(__gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<xc.Task>(L, 4)&& translator.Assignable<System.Collections.Generic.IComparer<xc.Task>>(L, 5)) 
                {
                    int index = LuaAPI.xlua_tointeger(L, 2);
                    int count = LuaAPI.xlua_tointeger(L, 3);
                    xc.Task item = (xc.Task)translator.GetObject(L, 4, typeof(xc.Task));
                    System.Collections.Generic.IComparer<xc.Task> comparer = (System.Collections.Generic.IComparer<xc.Task>)translator.GetObject(L, 5, typeof(System.Collections.Generic.IComparer<xc.Task>));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<xc.Task>.BinarySearch!");
            ...
            try {
                
                {
                    System.Predicate<xc.Task> match = translator.GetDelegate<System.Predicate<xc.Task>>(L, 2);
                        ...
                        xc.Task __cl_gen_ret = __cl_gen_to_be_invoked.Find( match );
                        translator.Push(L, __cl_gen_ret);
            ...
            try {
                
                {
                    System.Predicate<xc.Task> match = translator.GetDelegate<System.Predicate<xc.Task>>(L, 2);
                        ...
                        System.Collections.Generic.List<xc.Task> __cl_gen_ret = __cl_gen_to_be_invoked.FindAll( match );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _m_FindIndex(RealStatePtr L)
        {
            ...
            try {
                if(__gen_param_count == 2&& translator.Assignable<System.Predicate<xc.Task>>(L, 2)) 
                {
                    System.Predicate<xc.Task> match = translator.GetDelegate<System.Predicate<xc.Task>>(L, 2);
                ...
                if(__gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<System.Predicate<xc.Task>>(L, 3)) 
                {
                    int startIndex = LuaAPI.xlua_tointeger(L, 2);
                    System.Predicate<xc.Task> match = translator.GetDelegate<System.Predicate<xc.Task>>(L, 3);
                ...
                if(__gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<System.Predicate<xc.Task>>(L, 4)) 
                {
                    int startIndex = LuaAPI.xlua_tointeger(L, 2);
                    int count = LuaAPI.xlua_tointeger(L, 3);
                    System.Predicate<xc.Task> match = translator.GetDelegate<System.Predicate<xc.Task>>(L, 4);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<xc.Task>.FindIndex!");
        ...
        static int _m_FindLastIndex(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<xc.Task>.FindLastIndex!");
        ...
        static int _m_ForEach(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    System.Action<xc.Task> action = translator.GetDelegate<System.Action<xc.Task>>(L, 2);
        ...
        static int _m_GetEnumerator(RealStatePtr L)
        {
            ...
            try {
                
                {
                        ...
                        System.Collections.Generic.List<xc.Task>.Enumerator __cl_gen_ret = __cl_gen_to_be_invoked.GetEnumerator(  );
                        translator.Push(L, __cl_gen_ret);
            ...
            try {
                
                {
                    ...
                    int count = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        System.Collections.Generic.List<xc.Task> __cl_gen_ret = __cl_gen_to_be_invoked.GetRange( index, count );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _m_IndexOf(RealStatePtr L)
        {
            ...
            try {
                ...
                if(__gen_param_count == 4&& translator.Assignable<xc.Task>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    xc.Task item = (xc.Task)translator.GetObject(L, 2, typeof(xc.Task));
                    int index = LuaAPI.xlua_tointeger(L, 3);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<xc.Task>.IndexOf!");
        ...
        static int _m_Insert(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    int index = LuaAPI.xlua_tointeger(L, 2);
                    xc.Task item = (xc.Task)translator.GetObject(L, 3, typeof(xc.Task));
        ...
        static int _m_InsertRange(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    int index = LuaAPI.xlua_tointeger(L, 2);
                    System.Collections.Generic.IEnumerable<xc.Task> collection = (System.Collections.Generic.IEnumerable<xc.Task>)translator.GetObject(L, 3, typeof(System.Collections.Generic.IEnumerable<xc.Task>));
        ...
        static int _m_LastIndexOf(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<xc.Task>.LastIndexOf!");
        ...
        static int _m_Reverse(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<xc.Task>.Reverse!");
        ...
        static int _m_Sort(RealStatePtr L)
        {
            ...
            try {
                ...
                if(__gen_param_count == 2&& translator.Assignable<System.Collections.Generic.IComparer<xc.Task>>(L, 2)) 
                {
                    System.Collections.Generic.IComparer<xc.Task> comparer = (System.Collections.Generic.IComparer<xc.Task>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IComparer<xc.Task>));
                ...
                if(__gen_param_count == 2&& translator.Assignable<System.Comparison<xc.Task>>(L, 2)) 
                {
                    System.Comparison<xc.Task> comparison = translator.GetDelegate<System.Comparison<xc.Task>>(L, 2);
                ...
                if(__gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<System.Collections.Generic.IComparer<xc.Task>>(L, 4)) 
                {
                    int index = LuaAPI.xlua_tointeger(L, 2);
                    int count = LuaAPI.xlua_tointeger(L, 3);
                    System.Collections.Generic.IComparer<xc.Task> comparer = (System.Collections.Generic.IComparer<xc.Task>)translator.GetObject(L, 4, typeof(System.Collections.Generic.IComparer<xc.Task>));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<xc.Task>.Sort!");
        ...
        static int _m_ToArray(RealStatePtr L)
        {
            ...
            try {
                
                {
                        ...
                        xc.Task[] __cl_gen_ret = __cl_gen_to_be_invoked.ToArray(  );
                        translator.Push(L, __cl_gen_ret);
