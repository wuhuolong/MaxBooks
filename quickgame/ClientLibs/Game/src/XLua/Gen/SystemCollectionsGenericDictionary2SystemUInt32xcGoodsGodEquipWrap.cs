...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemCollectionsGenericDictionary_2_SystemUInt32xcGoodsGodEquip_Wrap
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			XUtils.BeginObjectRegister(typeof(System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip>), L, translator, 0, 9, 4, 0);
			...
			XUtils.EndObjectRegister(typeof(System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip>), L, translator, __CSIndexer, __NewIndexer,
			    null, null, null);

		    XUtils.BeginClassRegister(typeof(System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip>), L, __CreateInstance, 1, 0, 0);
			
			
            
            XUtils.RegisterObject(L, translator, XUtils.CLS_IDX, "UnderlyingSystemType", typeof(System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip>));
			
			
			XUtils.EndClassRegister(typeof(System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip>), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip>();
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IEqualityComparer<uint>>(L, 2))
				{
					...
					System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip>(comparer);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IDictionary<uint, xc.GoodsGodEquip>>(L, 2))
				{
					System.Collections.Generic.IDictionary<uint, xc.GoodsGodEquip> dictionary = (System.Collections.Generic.IDictionary<uint, xc.GoodsGodEquip>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IDictionary<uint, xc.GoodsGodEquip>));
					
					System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip>(dictionary);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip>(capacity);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<System.Collections.Generic.IDictionary<uint, xc.GoodsGodEquip>>(L, 2) && translator.Assignable<System.Collections.Generic.IEqualityComparer<uint>>(L, 3))
				{
					System.Collections.Generic.IDictionary<uint, xc.GoodsGodEquip> dictionary = (System.Collections.Generic.IDictionary<uint, xc.GoodsGodEquip>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IDictionary<uint, xc.GoodsGodEquip>));
					...
					System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip>(dictionary, comparer);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 3 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<System.Collections.Generic.IEqualityComparer<uint>>(L, 3))
				{
					...
					System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip> __cl_gen_ret = new System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip>(capacity, comparer);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip> constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
        ...
        public static int __NewIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<xc.GoodsGodEquip>(L, 3))
				{
					
					System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip> __cl_gen_to_be_invoked = (System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip>)translator.FastGetCSObj(L, 1);
					uint key = LuaAPI.xlua_touint(L, 2);
					__cl_gen_to_be_invoked[key] = (xc.GoodsGodEquip)translator.GetObject(L, 3, typeof(xc.GoodsGodEquip));
					LuaAPI.lua_pushboolean(L, true);
					return 1;
				}
        ...
        static int _m_GetEnumerator(RealStatePtr L)
        {
            ...
            try {
                
                {
                        ...
                        System.Collections.Generic.Dictionary<uint, xc.GoodsGodEquip>.Enumerator __cl_gen_ret = __cl_gen_to_be_invoked.GetEnumerator(  );
                        translator.Push(L, __cl_gen_ret);
