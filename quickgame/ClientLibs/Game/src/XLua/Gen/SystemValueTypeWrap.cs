...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemValueTypeWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			XUtils.BeginObjectRegister(typeof(System.ValueType), L, translator, 0, 3, 0, 0);
			...
			XUtils.EndObjectRegister(typeof(System.ValueType), L, translator, null, null,
			    null, null, null);

		    XUtils.BeginClassRegister(typeof(System.ValueType), L, __CreateInstance, 1, 0, 0);
			
			
            
            XUtils.RegisterObject(L, translator, XUtils.CLS_IDX, "UnderlyingSystemType", typeof(System.ValueType));
			
			
			XUtils.EndClassRegister(typeof(System.ValueType), L, translator);
        }
