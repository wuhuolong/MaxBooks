...
namespace XLua.CSObjectWrap
{
    ...
    public class xcGoodsItemWrap
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			XUtils.BeginObjectRegister(typeof(xc.GoodsItem), L, translator, 0, 10, 67, 66);
			
			XUtils.RegisterFunc(L, XUtils.METHOD_IDX, "CreateGoodsByTypeId", _m_CreateGoodsByTypeId);
			XUtils.RegisterFunc(L, XUtils.METHOD_IDX, "SetIdFindData", _m_SetIdFindData);
            ...
            XUtils.RegisterFunc(L, XUtils.GETTER_IDX, "isUICheck", _g_get_isUICheck);
            ...
            XUtils.RegisterFunc(L, XUtils.GETTER_IDX, "use_pay", _g_get_use_pay);
            XUtils.RegisterFunc(L, XUtils.GETTER_IDX, "use_cost", _g_get_use_cost);
            ...
            XUtils.RegisterFunc(L, XUtils.GETTER_IDX, "IsSourceCompose", _g_get_IsSourceCompose);
            ...
            XUtils.RegisterFunc(L, XUtils.GETTER_IDX, "CanAddShelvesToMarket", _g_get_CanAddShelvesToMarket);
            XUtils.RegisterFunc(L, XUtils.GETTER_IDX, "bag_type", _g_get_bag_type);
            ...
            XUtils.RegisterFunc(L, XUtils.SETTER_IDX, "isUICheck", _s_set_isUICheck);
            ...
            XUtils.RegisterFunc(L, XUtils.SETTER_IDX, "use_pay", _s_set_use_pay);
            XUtils.RegisterFunc(L, XUtils.SETTER_IDX, "use_cost", _s_set_use_cost);
            ...
            XUtils.RegisterFunc(L, XUtils.SETTER_IDX, "IsSourceCompose", _s_set_IsSourceCompose);
            ...
            XUtils.RegisterFunc(L, XUtils.SETTER_IDX, "bag_type", _s_set_bag_type);
            
			XUtils.EndObjectRegister(typeof(xc.GoodsItem), L, translator, null, null,
			    null, null, null);

		    XUtils.BeginClassRegister(typeof(xc.GoodsItem), L, __CreateInstance, 1, 0, 0);
			
			
            
            XUtils.RegisterObject(L, translator, XUtils.CLS_IDX, "UnderlyingSystemType", typeof(xc.GoodsItem));
			
			
			XUtils.EndClassRegister(typeof(xc.GoodsItem), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					xc.GoodsItem __cl_gen_ret = new xc.GoodsItem(type_id);
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					xc.GoodsItem __cl_gen_ret = new xc.GoodsItem();
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<Net.PkgGoodsInfo>(L, 2))
				{
					...
					xc.GoodsItem __cl_gen_ret = new xc.GoodsItem(pkgGoodsInfo);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to xc.GoodsItem constructor!");
        ...
        static int _m_CreateGoodsByTypeId(RealStatePtr L)
        {
            ...
            xc.GoodsItem __cl_gen_to_be_invoked = (xc.GoodsItem)translator.FastGetCSObj(L, 1);
            ...
            try {
                
                {
                    ...
                    __cl_gen_to_be_invoked.CreateGoodsByTypeId( _id );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetIdFindData(RealStatePtr L)
        {
            ...
            try {
                
                {
                    uint _id = LuaAPI.xlua_touint(L, 2);
                        ...
                        xc.Goods __cl_gen_ret = __cl_gen_to_be_invoked.SetIdFindData( _id );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _m_Copy(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    xc.Goods _goods = (xc.Goods)translator.GetObject(L, 2, typeof(xc.Goods));
                    
                        xc.Goods __cl_gen_ret = __cl_gen_to_be_invoked.Copy( _goods );
                        translator.Push(L, __cl_gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_isUICheck(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
			
                xc.GoodsItem __cl_gen_to_be_invoked = (xc.GoodsItem)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.isUICheck);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_use_pay(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
			
                xc.GoodsItem __cl_gen_to_be_invoked = (xc.GoodsItem)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushuint(L, __cl_gen_to_be_invoked.use_pay);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_use_cost(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
			
                xc.GoodsItem __cl_gen_to_be_invoked = (xc.GoodsItem)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushuint(L, __cl_gen_to_be_invoked.use_cost);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_IsSourceCompose(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
			
                xc.GoodsItem __cl_gen_to_be_invoked = (xc.GoodsItem)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushuint(L, __cl_gen_to_be_invoked.IsSourceCompose);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_CanAddShelvesToMarket(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
			
                xc.GoodsItem __cl_gen_to_be_invoked = (xc.GoodsItem)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.CanAddShelvesToMarket);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_bag_type(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
			
                xc.GoodsItem __cl_gen_to_be_invoked = (xc.GoodsItem)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, __cl_gen_to_be_invoked.bag_type);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_isUICheck(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
			
                xc.GoodsItem __cl_gen_to_be_invoked = (xc.GoodsItem)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.isUICheck = LuaAPI.lua_toboolean(L, 2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_use_pay(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
			
                xc.GoodsItem __cl_gen_to_be_invoked = (xc.GoodsItem)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.use_pay = LuaAPI.xlua_touint(L, 2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_use_cost(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
			
                xc.GoodsItem __cl_gen_to_be_invoked = (xc.GoodsItem)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.use_cost = LuaAPI.xlua_touint(L, 2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_IsSourceCompose(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
			
                xc.GoodsItem __cl_gen_to_be_invoked = (xc.GoodsItem)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.IsSourceCompose = LuaAPI.xlua_touint(L, 2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_bag_type(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
			
                xc.GoodsItem __cl_gen_to_be_invoked = (xc.GoodsItem)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.bag_type = (ushort)LuaAPI.xlua_tointeger(L, 2);
