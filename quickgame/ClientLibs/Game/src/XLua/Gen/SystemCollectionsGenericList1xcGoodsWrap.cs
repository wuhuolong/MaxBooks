...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemCollectionsGenericList_1_xcGoods_Wrap
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			XUtils.BeginObjectRegister(typeof(System.Collections.Generic.List<xc.Goods>), L, translator, 0, 29, 2, 1);
			...
			XUtils.EndObjectRegister(typeof(System.Collections.Generic.List<xc.Goods>), L, translator, __CSIndexer, __NewIndexer,
			    null, null, null);

		    XUtils.BeginClassRegister(typeof(System.Collections.Generic.List<xc.Goods>), L, __CreateInstance, 1, 0, 0);
			
			
            
            XUtils.RegisterObject(L, translator, XUtils.CLS_IDX, "UnderlyingSystemType", typeof(System.Collections.Generic.List<xc.Goods>));
			
			
			XUtils.EndClassRegister(typeof(System.Collections.Generic.List<xc.Goods>), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					System.Collections.Generic.List<xc.Goods> __cl_gen_ret = new System.Collections.Generic.List<xc.Goods>();
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Collections.Generic.IEnumerable<xc.Goods>>(L, 2))
				{
					System.Collections.Generic.IEnumerable<xc.Goods> collection = (System.Collections.Generic.IEnumerable<xc.Goods>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IEnumerable<xc.Goods>));
					
					System.Collections.Generic.List<xc.Goods> __cl_gen_ret = new System.Collections.Generic.List<xc.Goods>(collection);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
					...
					System.Collections.Generic.List<xc.Goods> __cl_gen_ret = new System.Collections.Generic.List<xc.Goods>(capacity);
					translator.Push(L, __cl_gen_ret);
					return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<xc.Goods> constructor!");
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<System.Collections.Generic.List<xc.Goods>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
        ...
        public static int __NewIndexer(RealStatePtr L)
        {
			...
			try {
				...
				if (translator.Assignable<System.Collections.Generic.List<xc.Goods>>(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && translator.Assignable<xc.Goods>(L, 3))
				{
					
					System.Collections.Generic.List<xc.Goods> __cl_gen_to_be_invoked = (System.Collections.Generic.List<xc.Goods>)translator.FastGetCSObj(L, 1);
					int key = LuaAPI.xlua_tointeger(L, 2);
					__cl_gen_to_be_invoked[key] = (xc.Goods)translator.GetObject(L, 3, typeof(xc.Goods));
					LuaAPI.lua_pushboolean(L, true);
					return 1;
				}
        ...
        static int _m_AsReadOnly(RealStatePtr L)
        {
            ...
            try {
                
                {
                        ...
                        System.Collections.ObjectModel.ReadOnlyCollection<xc.Goods> __cl_gen_ret = __cl_gen_to_be_invoked.AsReadOnly(  );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _m_CopyTo(RealStatePtr L)
        {
            ...
            try {
                if(__gen_param_count == 2&& translator.Assignable<xc.Goods[]>(L, 2)) 
                {
                    xc.Goods[] array = (xc.Goods[])translator.GetObject(L, 2, typeof(xc.Goods[]));
                ...
                if(__gen_param_count == 3&& translator.Assignable<xc.Goods[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    xc.Goods[] array = (xc.Goods[])translator.GetObject(L, 2, typeof(xc.Goods[]));
                ...
                if(__gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<xc.Goods[]>(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    int index = LuaAPI.xlua_tointeger(L, 2);
                    xc.Goods[] array = (xc.Goods[])translator.GetObject(L, 3, typeof(xc.Goods[]));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<xc.Goods>.CopyTo!");
            ...
            try {
                
                {
                    System.Predicate<xc.Goods> match = translator.GetDelegate<System.Predicate<xc.Goods>>(L, 2);
                        ...
                        xc.Goods __cl_gen_ret = __cl_gen_to_be_invoked.Find( match );
                        translator.Push(L, __cl_gen_ret);
            ...
            try {
                
                {
                    System.Predicate<xc.Goods> match = translator.GetDelegate<System.Predicate<xc.Goods>>(L, 2);
                        ...
                        System.Collections.Generic.List<xc.Goods> __cl_gen_ret = __cl_gen_to_be_invoked.FindAll( match );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _m_FindIndex(RealStatePtr L)
        {
            ...
            try {
                if(__gen_param_count == 2&& translator.Assignable<System.Predicate<xc.Goods>>(L, 2)) 
                {
                    System.Predicate<xc.Goods> match = translator.GetDelegate<System.Predicate<xc.Goods>>(L, 2);
                ...
                if(__gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<System.Predicate<xc.Goods>>(L, 3)) 
                {
                    int startIndex = LuaAPI.xlua_tointeger(L, 2);
                    System.Predicate<xc.Goods> match = translator.GetDelegate<System.Predicate<xc.Goods>>(L, 3);
                ...
                if(__gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<System.Predicate<xc.Goods>>(L, 4)) 
                {
                    int startIndex = LuaAPI.xlua_tointeger(L, 2);
                    int count = LuaAPI.xlua_tointeger(L, 3);
                    System.Predicate<xc.Goods> match = translator.GetDelegate<System.Predicate<xc.Goods>>(L, 4);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<xc.Goods>.FindIndex!");
        ...
        static int _m_FindLastIndex(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<xc.Goods>.FindLastIndex!");
        ...
        static int _m_ForEach(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    System.Action<xc.Goods> action = translator.GetDelegate<System.Action<xc.Goods>>(L, 2);
        ...
        static int _m_GetEnumerator(RealStatePtr L)
        {
            ...
            try {
                
                {
                        ...
                        System.Collections.Generic.List<xc.Goods>.Enumerator __cl_gen_ret = __cl_gen_to_be_invoked.GetEnumerator(  );
                        translator.Push(L, __cl_gen_ret);
            ...
            try {
                
                {
                    ...
                    int count = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        System.Collections.Generic.List<xc.Goods> __cl_gen_ret = __cl_gen_to_be_invoked.GetRange( index, count );
                        translator.Push(L, __cl_gen_ret);
        ...
        static int _m_IndexOf(RealStatePtr L)
        {
            ...
            try {
                ...
                if(__gen_param_count == 4&& translator.Assignable<xc.Goods>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    xc.Goods item = (xc.Goods)translator.GetObject(L, 2, typeof(xc.Goods));
                    int index = LuaAPI.xlua_tointeger(L, 3);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<xc.Goods>.IndexOf!");
        ...
        static int _m_Insert(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    int index = LuaAPI.xlua_tointeger(L, 2);
                    xc.Goods item = (xc.Goods)translator.GetObject(L, 3, typeof(xc.Goods));
        ...
        static int _m_InsertRange(RealStatePtr L)
        {
            ...
            try {
                ...
                {
                    int index = LuaAPI.xlua_tointeger(L, 2);
                    System.Collections.Generic.IEnumerable<xc.Goods> collection = (System.Collections.Generic.IEnumerable<xc.Goods>)translator.GetObject(L, 3, typeof(System.Collections.Generic.IEnumerable<xc.Goods>));
        ...
        static int _m_LastIndexOf(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<xc.Goods>.LastIndexOf!");
        ...
        static int _m_Reverse(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<xc.Goods>.Reverse!");
        ...
        static int _m_Sort(RealStatePtr L)
        {
            ...
            try {
                ...
                if(__gen_param_count == 2&& translator.Assignable<System.Collections.Generic.IComparer<xc.Goods>>(L, 2)) 
                {
                    System.Collections.Generic.IComparer<xc.Goods> comparer = (System.Collections.Generic.IComparer<xc.Goods>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IComparer<xc.Goods>));
                ...
                if(__gen_param_count == 2&& translator.Assignable<System.Comparison<xc.Goods>>(L, 2)) 
                {
                    System.Comparison<xc.Goods> comparison = translator.GetDelegate<System.Comparison<xc.Goods>>(L, 2);
                ...
                if(__gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<System.Collections.Generic.IComparer<xc.Goods>>(L, 4)) 
                {
                    int index = LuaAPI.xlua_tointeger(L, 2);
                    int count = LuaAPI.xlua_tointeger(L, 3);
                    System.Collections.Generic.IComparer<xc.Goods> comparer = (System.Collections.Generic.IComparer<xc.Goods>)translator.GetObject(L, 4, typeof(System.Collections.Generic.IComparer<xc.Goods>));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.List<xc.Goods>.Sort!");
        ...
        static int _m_ToArray(RealStatePtr L)
        {
            ...
            try {
                
                {
                        ...
                        xc.Goods[] __cl_gen_ret = __cl_gen_to_be_invoked.ToArray(  );
                        translator.Push(L, __cl_gen_ret);
