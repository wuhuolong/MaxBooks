...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIHorizontalLayoutGroupWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			XUtils.BeginObjectRegister(typeof(UnityEngine.UI.HorizontalLayoutGroup), L, translator, 0, 4, 0, 0);
			...
			XUtils.EndObjectRegister(typeof(UnityEngine.UI.HorizontalLayoutGroup), L, translator, null, null,
			    null, null, null);

		    XUtils.BeginClassRegister(typeof(UnityEngine.UI.HorizontalLayoutGroup), L, __CreateInstance, 1, 0, 0);
			
			
            
            XUtils.RegisterObject(L, translator, XUtils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.UI.HorizontalLayoutGroup));
			
			
			XUtils.EndClassRegister(typeof(UnityEngine.UI.HorizontalLayoutGroup), L, translator);
        }
