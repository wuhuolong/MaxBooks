...
namespace XLua.CSObjectWrap
{
    ...
    public class xcuiuguiTweenAnchoredPositionWrap
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			XUtils.BeginObjectRegister(typeof(xc.ui.ugui.TweenAnchoredPosition), L, translator, 0, 2, 4, 3);
			...
			XUtils.EndObjectRegister(typeof(xc.ui.ugui.TweenAnchoredPosition), L, translator, null, null,
			    null, null, null);

		    XUtils.BeginClassRegister(typeof(xc.ui.ugui.TweenAnchoredPosition), L, __CreateInstance, 2, 0, 0);
			XUtils.RegisterFunc(L, XUtils.CLS_IDX, "Begin", _m_Begin_xlua_st_);
            
			
            
            XUtils.RegisterObject(L, translator, XUtils.CLS_IDX, "UnderlyingSystemType", typeof(xc.ui.ugui.TweenAnchoredPosition));
			
			
			XUtils.EndClassRegister(typeof(xc.ui.ugui.TweenAnchoredPosition), L, translator);
        }
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					xc.ui.ugui.TweenAnchoredPosition __cl_gen_ret = new xc.ui.ugui.TweenAnchoredPosition();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to xc.ui.ugui.TweenAnchoredPosition constructor!");
        ...
        static int _m_SetStartToCurrentValue(RealStatePtr L)
        {
            ...
            xc.ui.ugui.TweenAnchoredPosition __cl_gen_to_be_invoked = (xc.ui.ugui.TweenAnchoredPosition)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_value(RealStatePtr L)
        {
            ...
            try {
                ...
                xc.ui.ugui.TweenAnchoredPosition __cl_gen_to_be_invoked = (xc.ui.ugui.TweenAnchoredPosition)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineVector2(L, __cl_gen_to_be_invoked.value);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_from(RealStatePtr L)
        {
            ...
            try {
                ...
                xc.ui.ugui.TweenAnchoredPosition __cl_gen_to_be_invoked = (xc.ui.ugui.TweenAnchoredPosition)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineVector2(L, __cl_gen_to_be_invoked.from);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_to(RealStatePtr L)
        {
            ...
            try {
                ...
                xc.ui.ugui.TweenAnchoredPosition __cl_gen_to_be_invoked = (xc.ui.ugui.TweenAnchoredPosition)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineVector2(L, __cl_gen_to_be_invoked.to);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
