...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineVector3Wrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			XUtils.BeginObjectRegister(typeof(UnityEngine.Vector3), L, translator, 6, 6, 6, 3);
			...
			XUtils.EndObjectRegister(typeof(UnityEngine.Vector3), L, translator, __CSIndexer, __NewIndexer,
			    null, null, null);

		    XUtils.BeginClassRegister(typeof(UnityEngine.Vector3), L, __CreateInstance, 25, 10, 0);
            ...
            XUtils.RegisterFunc(L, XUtils.CLS_IDX, "OrthoNormalize", _m_OrthoNormalize_xlua_st_);
            ...
            XUtils.RegisterFunc(L, XUtils.CLS_IDX, "Cross", _m_Cross_xlua_st_);
            XUtils.RegisterFunc(L, XUtils.CLS_IDX, "Reflect", _m_Reflect_xlua_st_);
            XUtils.RegisterFunc(L, XUtils.CLS_IDX, "Normalize", _m_Normalize_xlua_st_);
            XUtils.RegisterFunc(L, XUtils.CLS_IDX, "Dot", _m_Dot_xlua_st_);
            XUtils.RegisterFunc(L, XUtils.CLS_IDX, "Project", _m_Project_xlua_st_);
            XUtils.RegisterFunc(L, XUtils.CLS_IDX, "ProjectOnPlane", _m_ProjectOnPlane_xlua_st_);
            ...
            XUtils.RegisterFunc(L, XUtils.CLS_IDX, "Magnitude", _m_Magnitude_xlua_st_);
            ...
            XUtils.RegisterObject(L, translator, XUtils.CLS_IDX, "kEpsilon", UnityEngine.Vector3.kEpsilon);
            
            XUtils.RegisterObject(L, translator, XUtils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.Vector3));
			XUtils.RegisterFunc(L, XUtils.CLS_GETTER_IDX, "zero", _g_get_zero);
            XUtils.RegisterFunc(L, XUtils.CLS_GETTER_IDX, "one", _g_get_one);
            XUtils.RegisterFunc(L, XUtils.CLS_GETTER_IDX, "forward", _g_get_forward);
            XUtils.RegisterFunc(L, XUtils.CLS_GETTER_IDX, "back", _g_get_back);
			...
			XUtils.EndClassRegister(typeof(UnityEngine.Vector3), L, translator);
        }
